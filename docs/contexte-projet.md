...
- **Distribution iOS** : environnement local fonctionnel depuis le 19/08/2026 (Xcode, CocoaPods, simulateur — voir pièges plus haut). L'app tourne en natif sur simulateur, écran de connexion et config Supabase OK. Reste à faire : build EAS iOS de production (jamais tenté), puis choix du canal de distribution (ad hoc vs TestFlight).
